...
"The girl at the booth sold fifty bonds.The small pup gnawed a hole in the sock.",
...
"Read verse out loud for pleasure.Hoist the load to your left shoulder.",
...
"What joy there is in living.A king ruled the state in the early days.",
...
"He lay prone and hardly moved a limb.The slush lay deep along the street.",
...
"The bill as paid every third week.Oak is strong and also gives shade.",
...
"Move the vat over the hot fire.The bark of the pine tree was shiny and dark.",
...
"We find joy in the simplest things.Type out three lists of orders.",
...
"The tiny girl took off her hat.A cramp is no small danger on a swim.",
...
"Port is a strong wine with s smoky taste.The young kid jumped the rusty gate.",
...
"The cigar burned a hole in the desk top.The empty flask stood on the tin tray.",
...
"The sofa cushion is red and of light weight.The jacket hung on the back of the wide chair.",
...
"A shower of dirt fell from the hot pipes.Steam hissed from the broken valve.",
...
"Add the store's account to the last cent.Acid burns holes in wool cloth.",
...
"She has st smart way of wearing clothes.The fruit of a fig tree is apple-shaped.",
...
"Farmers came in to thresh the oat crop.The brown house was on fire to the attic.",
...
"Even the worst will beat his low score.The cement had dried when he moved it.",
...
"The wreck occurred by the bank on Main Street.A pencil with black lead writes best.",
...
"Slash the gold cloth into fine ribbons.Try to have the court decide the case.",
...
"Madam, this is the best brand of corn.On the islands the sea breeze is soft and mild.",
...
"Jump the fence and hurry up the bank.Yell and clap as the curtain slides back.",
...
"Canned pears lack full flavor.The dark pot hung in the front closet.",
...
"A zestful food is the hot-cross bun.The horse trotted around the field at a brisk pace.",
...
"Soak the cloth and drown the sharp odor.The shelves were bare of both jam or crackers.",
...
"Tin cans are absent from store shelves.Slide the box into that empty space.",
...
"The fight will end in just six minutes.The store walls were lined with colored frocks.",
...
"Men think and plan and sometimes act.Fill the ink jar with sticky glue.",
...
"Bathe and relax in the cool green grass.Nine rows of soldiers stood in line.",
...
"Code is used when secrets are sent.Most of the new is easy for us to hear.",
...
"Next Tuesday we must vote.Pour the stew from the pot into the plate.",
...
"It takes a good trap to capture a bear.Feed the white mouse some flower seeds.",
...
"Tend the sheep while the dog wanders.It takes a lot of help to finish these.",
...
"That move means the game is over.He wrote down a long of items.",
...
"The sun came up to light the eastern sky.Heave the line over the port side.",
...
"The cone costs five cents on Mondays.A pod is what peas always grow in.",
"Jerk the dart from the cork target.",
"No cement will hold hard wood.",
"We now have a new base for shipping.",
"The of names is carved around the base.",
...
"Grace makes up for lack of beauty.Nudge gently but wake her now.",
...
"There is a lag between thought and act.Seed is needed to plant the spring corn.",
...
"Screen the porch with woven straw mats.This horse will nose his way to the finish.",
...
"The marsh will freeze when cold enough.They slice the sausage thin with a knife.",
...
"Throw out the used paper cup and plate.A clean neck means a neat collar.",
...
"The price is fair for a good antique clock.The music played on while they talked.",
...
"The chair looked strong but had no bottom.The kite flew wildly in the high wind.",
...
"A fence cuts through the corner lot.The way to save money is not to spend much.",
...
"In the rear of the ground floor was a large passage.A man in a blue sweater sat at the desk.",
...
"Take a chance and win a china doll.Shake the dust from your shoes, stranger.",
...
"That guy is the writer of a few banned books.The little tales they tell are false.",
...
"The beetle droned in the hot June sun.Press the pedal with your left foot.",
...
"Fill your pack with bright trinkets for the poor.The small red neon lamp went out.",
...
"A break in the dam almost caused a flood.Paint the sockets in the wall dull green.",
...
"Prod the old mule with a crooked stick.It is a band of steel three inches wide.",
...
"Next Sunday is the twelfth of the month.Every word and phrase he speaks is true.",
...
"A sullen smile gets few friends.Stop whistling and watch the boys march.",
...
"Choose between the high road and the low.A plea for funds seems to come again.",
...
"Lush fern grow on the lofty rocks.The ram scared the school children off.",
...
"The latch on the beck gate needed a nail.The goose was brought straight from the old market.",
...
"Post no bills on this office wall.Tear a thin sheet from the yellow pad.",
...
"Bad nerves are jangled by a door slam.Ship maps are different from those for planes.",
...
"The knife was hung inside its bright sheath.The rarest spice comes from the far East.",
...
"Dunk the stale biscuits into strong drink.Hang tinsel from both branches.",
...
"You cannot brew tea in a cold pot.Dots of light betrayed the black cat.",
...
"Dig deep in the earth for pirate's gold.The steady drip is worse than a drenching rain.",
...
"Our troops are set to strike heavy blows.The store was jammed before the sale could start.",
...
"The pup jerked the leash as he saw a feline shape.Open your book to the first page.",
...
"The corner store was robbed last night.A gold ring will please most any girl.",
